...
// 5. 금액을 입력하면 환전됨
// 6. 드랍다운 리스트에 아이템을 선택하면 다시 그 단위 기준으로 환전이 됨
// 7. 숫자를 한국어로 읽는 법
// 8. 반대로 밑에 박스에서 숫자를 바꿔도 위에 박스에 환율이 적용됨
...
function convert(){
    //1. 환전
    //2. 얼마를 환전? 가지고있는 돈이 뭔지, 바꾸고자 하는 돈이 뭔지
    //3. 돈 환율 환전금액
    let amount = document.getElementById("from-input").value;
    let convertedAmount = amount * currencyRatio[fromCurrency][toCurrency]
    console.log("exchange result", convertedAmount);
